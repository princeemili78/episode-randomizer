...
# After an episode has been generated a page with the episode and other information is generated for the user
    ...
    if "Firefox" in st.session_state["user_agent"]:
        ...
        #st.components.v1.html(f'<iframe src="https://www.2embed.cc/embedtv/{st.session_state["episode"].imdb_id}&s={st.session_state["episode"].season}&e={st.session_state["episode"].number}" width="100%" height="520" allowfullscreen></iframe>', height=520)
