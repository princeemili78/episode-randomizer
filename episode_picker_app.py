...
# After an episode has been generated a page with the episode and other information is generated for the user
    ...
    if "Firefox" in st.session_state["user_agent"]:
        if "Mobile" in st.session_state["user_agent"]:
            st.components.v1.html(f'<iframe src="https://vidsrc-embed.su/embed/tv/{st.session_state["episode"].imdb_id}/{st.session_state["episode"].season}-{st.session_state["episode"].number}" style="width: 100%; height: 220px;" frameborder="0" referrerpolicy="origin" allowfullscreen></iframe>', height=220)
        else:
            st.components.v1.html(f'<iframe src="https://vidsrc-embed.su/embed/tv/{st.session_state["episode"].imdb_id}/{st.session_state["episode"].season}-{st.session_state["episode"].number}" width="100%" height=520 allowfullscreen></iframe>', height=520)
    else:
        if "Mobile" in st.session_state["user_agent"]:
            st.components.v1.html(f'<iframe src="https://vidsrc.cc/v2/embed/tv/{st.session_state["episode"].imdb_id}/{st.session_state["episode"].season}/{st.session_state["episode"].number}" style="width: 100%; height: 220px;" frameborder="0" referrerpolicy="origin" allowfullscreen></iframe>', height=220)
        else:
            st.components.v1.html(f'<iframe src="https://vidsrc.cc/v2/embed/tv/{st.session_state["episode"].imdb_id}/{st.session_state["episode"].season}/{st.session_state["episode"].number}" style="width: 100%; height: 520px;" frameborder="0" referrerpolicy="origin" allowfullscreen></iframe>', height=520)
